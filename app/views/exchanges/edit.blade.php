...
{{ Form::model($exchange, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('exchanges.update', $exchange->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('exchanges.show', 'Cancel', $exchange->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
