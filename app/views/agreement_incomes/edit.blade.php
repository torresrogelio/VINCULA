...
{{ Form::model($agreement_income, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('agreement_incomes.update', $agreement_income->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('agreement_incomes.show', 'Cancel', $agreement_income->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
