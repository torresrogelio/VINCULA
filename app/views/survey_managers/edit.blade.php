...
{{ Form::model($survey_manager, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('survey_managers.update', $survey_manager->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('survey_managers.show', 'Cancel', $survey_manager->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
