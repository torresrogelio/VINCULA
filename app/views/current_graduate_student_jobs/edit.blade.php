...
<div class="row">
    <div class="col-md-10 col-md-offset-2">
        <h1>Edit Current_graduate_student_job</h1>
...
{{ Form::model($current_graduate_student_job, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('current_graduate_student_jobs.update', $current_graduate_student_job->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('current_graduate_student_jobs.show', 'Cancel', $current_graduate_student_job->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
